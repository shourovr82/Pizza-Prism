import { Button, Divider, Input, NavbarBrand } from "@nextui-org/react";
      ...
      <div className="responsive-section">
        ...
        <div className="text-white grid grid-cols-5 ">
          <div className="col-span-3">
            <h1 className="font-fantasy text-2xl logoTitle selection:bg-[#f7870828]  ">
              Pizza Prism
            </h1>
          </div>
          <div className="col-span-2 flex items-center">
            <input
              type="text"
              className="border-b-2  text-[#F78908] font-semibold shadow-inner shadow-[#1d140d4b] bg-[#ffffff05] border-[#F78908] pb-0.5  w-full pt-2.5 focus:outline-none rounded-tl-xl  px-2 placeholder:text-[#54575a] placeholder:font-semibold placeholder:font-sans "
              placeholder="Enter Your Email Address"
            />{" "}
            <Button
              size="sm"
              className="rounded-none border-b-2 py-[16px] bg-[#ffffff05] hover:bg-[#F78908] text-[#F78908]  font-bold px-5 hover:text-white border-[#F78908]  rounded-tr-xl"
            >
              SUBMIT
            </Button>
          </div>
        ...
        {/* footer contents */}
        <div className=" mt-14 grid grid-cols-10 gap-3">
          ...
          {/* news letter */}
          <div className="col-span-3">
            <h2 className="text-[#fcfcfc] text-xl">Newsletter</h2>
        ...
        <div className="p-3 mt-10">
          ...
          />
          <p className="text-sm text-[#d8cab0b9] font-thin  flex justify-center items-center  gap-3 font-Barriecito text-center mt-10">
