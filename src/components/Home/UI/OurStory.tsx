...
const OurStory = () => {
  return (
    <section className="py-10 selection:bg-[#f78908] selection:text-white lg:py-20 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-10 items-center responsive-section">
