"use client";
import { Accordion, AccordionItem, CheckboxIcon } from "@nextui-org/react";
      ...
      <div>
        <Accordion variant="splitted" selectionMode="multiple">
          <AccordionItem
            ...
            startContent={
              <BiCheck className="bg-[#54ca92] h-12 w-12 p-2 rounded-full  text-white" />
            }
            title={
          ...
          <AccordionItem
            ...
            aria-label="Order #5490024"
            startContent={
              <FaXmark className="bg-[#eb4335] h-12 w-12 p-2 rounded-full  text-white" />
            }
            title={
              <div className="flex justify-between items-center">
                <div>
